...
-------------
To run the standalone app in your android device: 
1. Cd into StandAloneApp
2. Connect your android device to the computer
3. Transfer the file .apk file to your device and install in your mobile device
4. Open the installed app in your device
Note: remember to ask us for setting fb login permission so that you can use your Facebook account to login. Otherwise you cannot not login.

Please contact us if you have any problems with running the app.
s3686970@rmit.edu.vn
